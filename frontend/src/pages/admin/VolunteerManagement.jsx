      ...
      <div className="flex-1 flex flex-col min-w-0 lg:pl-72">
        ...
        <main className="p-4 sm:p-8 space-y-6 max-w-7xl w-full mx-auto">
          ...
          <div className="bg-white p-4 rounded-2xl border border-gray-100 shadow-xs flex items-center gap-3">
            ...
            <input
              type="text"
              placeholder="Search volunteers by name, email, phone, skills, or availability..."
              value={searchQuery}
                ...
                <table className="w-full text-left border-collapse text-sm">
                  <thead>
                    <tr className="border-b border-gray-100 bg-gray-50/50 text-[11px] uppercase tracking-wider text-[#667085]">
                      ...
                      <th className="py-3.5 px-4 font-bold text-center">Assigned Tasks</th>
